				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
                                <% 
                                    out.print("<a href='#' ");
                                    if(request.getParameter("indb")!=null || request.getParameter("dupplicate")!=null) out.print("id='login-form-link'>Login</a>");
                                    else out.print(" class='active' id='login-form-link'>Login</a>");
                                %>
							...
							<div class="col-xs-6">
                                <%
                                    ...
                                    if(request.getParameter("indb")!=null || request.getParameter("dupplicate")!=null || request.getParameter("errorPass")!=null) out.print(" class='active' ");
                                    else out.print(">Register</a>");
                                %>
							</div>
						</div>
						<hr>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
                                <%
                                    if(request.getParameter("pswdErr")!=null) out.print("<p style='color: red; text-align: center;'><b>Password errata!!!</b></p>");
                                    if(request.getParameter("indb")!=null){
                                        String resp = request.getParameter("indb");
                                        if(resp.equals("true")) out.print("<p style='color: red; text-align: center;'><b>Utente non trovato, registrati!</b></p>");
                                    }
                                    if(request.getParameter("dupplicate")!=null){
                                        String resp = request.getParameter("dupplicate");
                                        if(resp.equals("true")) out.print("<p style='color: red; text-align: center;'><b>Utente gia' presente, scegli un altro nome!</b></p>");
                                    }
                                    if(request.getParameter("errorPass")!=null){
                                        String resp = request.getParameter("errorPass");
                                        if(resp.equals("true")) out.print("<p style='color: red; text-align: center;'><b>Password non corrispondenti, scrivi correttamente le password!</b></p>");
                                    }
                                    
                                    //inizio form
                                    
                                    out.print("<form id='login-form' action='controlla_login.jsp' method='post' role='form'");
                                    if(request.getParameter("indb")!=null || request.getParameter("dupplicate")!=null || request.getParameter("errorPass")!=null) out.print(" style='display: none;'>");
                                    else out.print(" style='display: block;'>");
                                ...
                                <%
                                    ...
                                    if(request.getParameter("indb")!=null || request.getParameter("dupplicate")!=null || request.getParameter("errorPass")!=null) out.print(" style='display: block;'>");
